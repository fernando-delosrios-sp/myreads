...
export const update = async (book: BookData|BookRef, shelf: string): Promise<BookData> =>{
...
export const search = async (query: string, maxResults: number): Promise<BookData[]> =>{
